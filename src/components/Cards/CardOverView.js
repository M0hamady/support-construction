            ...
            <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-lightBlue-500">
              ...
              <blockquote className="relative p-8 mb-2">
                ...
                <p className="text-md font-light mt-2 text-white">
                  Working for Support construction means being part of a big
                  family – one whose members share a common culture and a set of
                  fundamental principles that shape the identity of our unique
                  Group..
                </p>
              </blockquote>
            </div>
                ...
                <div className="relative flex flex-col mt-4">
                  <div className="px-4 py-5 flex-auto text-left">
                    ...
                    <p className="mb-4 text-center text-blueGray-500">
                      ...
                      through support and training programmes.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative flex flex-col min-w-0">
                  <div className="px-4 py-5 flex-auto text-left">
                    ...
                    <p className="mb-4 text-center text-blueGray-500">
                      ...
                      exceeded all its financial targets.
                    </p>
                  </div>
                </div>
              </div>
        ...
        >
          <div className="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
            ...
            <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600">
              ...
              Support Construction, a Egyptian technology group with alot of
              employees, and a leader in terms of both innovation and financial
        ...
        <div className="items-center flex flex-wrap">
          <div className="w-full md:w-5/12 ml-auto px-12 md:px-4">
            <div className="md:pr-12">
              ...
              <p className="mt-4 text-lg leading-relaxed text-blueGray-500">
                ...
                years–and it keeps growing. Indeed, the global construction
                market is expected to grow to a massive $10.5 trillion by 2023.
                With this anticipated increase, today’s construction companies
                have their work cut out for them, to say the least. Beyond
                meeting our world’s most fundamental building needs,
                construction companies, large and small, are making a huge
          ...
          <div className="w-full md:w-6/12 mr-auto px-4 pt-24 md:pt-0">
            <img
              ...
              src={require("assets/img/construc10.png").default}
            />
          </div>
        </div>
      </div>
